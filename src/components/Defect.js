                        ...
                        {defect === 1 ? (
                            <>
                                ...
                                <p className="extrusion-text">
                                    <span style={{ color: '#61875E' }}>Недоэкструзия</span> — это результат недостаточной или
                                    нестабильной подачи расплава. Она выражается в ямках на поверхностях, дырах, а иногда и в
                                    пропущенных слоях.
                                </p>
                                <div className="ic">
                                    ...
                                    <div className="icon-text">
                                        ...
                                        <p className="icon-text-bottom">
                                            Попробуйте плавно повышать температуру хотэнда, шагами по пять-десять градусов, но
                                            будьте осторожны: превышать максимальную указанную производителем температуру не
                                ...
                                <div className="ic">
                                    ...
                                    <div className="icon-text">
                                        ...
                                        <p className="icon-text-bottom">
                                            Вероятно, что 3D-принтер чисто программно не успевает подавать материал, что и
                                            проводит к образованию дыр. Попробуйте повысить значение потока (Flow) небольшими
                                ...
                                <div className="ic">
                                    ...
                                    <div className="icon-text">
                                        ...
                                        <p className="icon-text-bottom">
                                            Грязные или изношенные шестерни подающего механизма тоже могут быть причиной
                                            нестабильной подачи филамента, как и недостаточный прижим шестерней. Чтобы шестерни
                                            не пробуксовывали, почистите механизм щеткой.
                                        </p>
                                    </div>
                                </div>
                            </>
                                        ...
                                        <div className="rating-scale">
                                            {ratingEmojis.map((emoji, index) => (
                                                <div
                                                    ...
                                                    onClick={() => !isSubmitted && handleRatingChange(index + 1)}
                                                >
                                                    {emoji}
                                                </div>
                                            ))}
